...
/// A class that contains all theme configurations for the cold plunge wellness application.
/// Implements Arctic Clarity color theme with Fluid Minimalism design principles.
class AppTheme {
  AppTheme._();
  ...
  // Card and dialog colors for depth hierarchy
  ...
  // Border colors for functional separation
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Floating action button for quick session starts
